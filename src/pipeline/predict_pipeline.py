...
class CustomData: #responsible for mapping all the inputs we give in the front end to the values in the backend
    def __init__(self,gender: str,race_ethnicity: str,parental_level_of_education: str,lunch: int,test_preparation_course: str,reading_score: int,writing_score: int) -> None:
